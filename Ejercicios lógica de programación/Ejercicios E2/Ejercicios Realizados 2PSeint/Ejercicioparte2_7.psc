Proceso Ejercicioparte2_7
	...
	Si num1 > num2 Y num1 > num3 Y num1 > num4 Entonces
		Escribir num1, " es mayor que todos";
	SiNo
		Si num2 > num1 Y num2 > num3 Y num2 > num4 Entonces
			Escribir num2, " es mayor que todos";
		SiNo
			Si num3 > num1 Y num3 > num2 Y num3 > num4 Entonces
				Escribir num3, " es mayor que todos";
			SiNo
				Escribir num4, " es mayor que todos";
			FinSi
		FinSi
	FinSi
FinProceso
